...
@section('main')
    ...
    <div class="templates templateOrderCreate" ng-controller="OrderCreateController" ng-cloak>
        ...
        <h1>Create Order <span ng-if="order.id">#{[{ order.id }]}</span> <span class="label label-primary" ng-show="order.is_quote">Quote</span></h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input ng-model="order.date_received" type="text" data-provide='datepicker' id='order_date_received' class='form-control input-sm' data-date-format='mm/dd/yyyy' />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="date_due">Date Due:</label>
                                    <input ng-model="order.date_due" type="text" data-provide='datepicker' id='order_date_received' class='form-control input-sm' data-date-format='mm/dd/yyyy' />
                                </div>
                            </div>
                        </div>
                        <div class="row">
