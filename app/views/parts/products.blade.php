  ...
  <div ng-controller="PartsProductsController as vmProducts" ng-cloak class="col-md-12">
      <div st-table="vmProducts.stFilteredProducts"
        ...
        <div class="row header-row">
            ...
            <div class="col-md-3 header-buttons"><a class="btn btn-default btn-sm" href="/parts/products/new">New Product</a></div>
        </div>
        <table class="table table-striped bestline-table">
          <thead>
            <tr>
              ...
              <th>Unit Price</th>
              <th>Pricing Type</th>
              <th><input st-search placeholder="Search" class="table-search input-sm form-control b-margin b-bottom" type="search"/></th>
            </tr>
          </thead>
