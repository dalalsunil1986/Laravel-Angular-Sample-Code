...
.directive('bestlineShadeDrawing', function($timeout) {
    ...
    bestlineShadeDrawing.controller = function($scope){
        ...
        function Shade(){
            ...
            shade.embellishmentClassName = (shade.embellishmentOption)? getEmbellishmentClassName(shade.embellishmentOption) : 'null';
        ...
        buildShadeDrawing.buildLayout = function(){
            ...
            function buildRows(){
                ...
                var bottomMeasurement = {
                    y: shape.y + shape.height + shape.marginBottom + shade.spacing * 1.5 + 3,
                    height: shade.spacing,
                }
        ...
        buildShadeDrawing.buildGeneralShapes = function(){
            ...
            function buildEmbellishment(){
                ...
                $scope.shade.drawing.embellishment = {
                    class: $scope.shade.embellishmentClassName,
                };
        ...
        function getEmbellishmentClassName(embellishmentOption) {
            var option = embellishmentOption.option;
            var id = option.id;
            var name = option.name;
            var className = "embellishment";
            if(name){
